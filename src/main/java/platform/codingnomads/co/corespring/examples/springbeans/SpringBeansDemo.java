...
public class SpringBeansDemo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Spring Developer Name: " + springDeveloper.getName().getFirstName() + " " +
                springDeveloper.getName().getLastName() +
                " Address: " + springDeveloper.getAddress().getStreetNumber() + " " +
